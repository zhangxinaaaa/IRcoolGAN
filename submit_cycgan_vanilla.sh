...
python3 train_cyclegan.py train ../working_cyclegan/vanilla_cycgan --data_dir ../working_cyclegan/data --data_slice_len 65536 --data_sample_rate 16000 --total_epochs 100 --sample_interval 1 --save_interval 1 --load_IRs
