...
python3 train_cyclegan.py train ../working_cyclegan/1s_model --data_dir ../working_cyclegan/data --data_slice_len 16384 --data_sample_rate 16000 --total_epochs 200 --sample_interval 1 --save_interval 1
