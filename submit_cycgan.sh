...
python3 train_cyclegan.py train ../working_cyclegan/classic_model --data_dir ../working_cyclegan/data --data_slice_len 65536 --data_sample_rate 16000 --total_epochs 100 --sample_interval 2 --save_interval 4 --load_IRs --resume_training 
