...
def train_cyclegan( args):
    ...
    gan = cycleGAN.cyclegan(X_trainA = X_train_ISM
                          ...
                          , idloss_weight = args.idlossweight)
...
if __name__ == '__main__':
    ...
    gan_args.add_argument("--idlossweight", help= 'Weight value of identity loss (hyperparameter)', type = int)
    gan_args.add_argument('--soft_labels',  action='store_true', dest='soft_labels',
        help='Use soft labels (0~0.1 for fake, 0.9~1 for real) for discriminator loss')
